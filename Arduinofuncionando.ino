...
#define oneHzSample 100000/maxSamplesNum  // sample for the 1Hz signal expressed in microseconds 
...
long muestra=50, prueba=0;
int contador=2;//contador que elije de la tabla que onda deseamos poner 
bool boton, anterior;// variables para evitar rebote del pulsante
 ...
 */
 /*
  prueba=analogRead(A1);
   muestra = map(prueba , 0, 1023,1,10000);//mapea la señal A0
