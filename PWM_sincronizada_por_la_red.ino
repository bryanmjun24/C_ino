...
#define GATE 10 //Asigno nombre para el pin donde se obtendrá la señal
int i=483;
void setup(){
 // Asignación de pines
...
{
pot=467; // Se asigna un valor a la salida
}
if (pot < 50) // para el 90% de relación de trabajo (0.1*520.83=52.083)
{
pot=50; // do something here
}
i=pot;
